...
TOOL_TO_STAGE = {
    "sequence_validator": "validation",
    "invalid_sequence_corrector": "validation",
    "multiple_sequence_alignment": "alignment",
    "mafft_sequence_alignment": "alignment",
    "muscle_sequence_alignment": "alignment",
    "clustalw_sequence_alignment": "alignment",
    "tree_constructor": "tree_construction",
    "fasttree_constructor": "tree_construction",
    "iqtree_constructor": "tree_construction",
    "raxml_constructor": "tree_construction",
    "identify_frequent_subtrees": "subtree_analysis",
    "dendropy_identify_frequent_subtrees": "subtree_analysis",
    "ete_identify_frequent_subtrees": "subtree_analysis",
    "treepattern_identify_frequent_subtrees": "subtree_analysis",
}
...
def collect_runs(sqlite_path: Path, condition: str, sailor_policy: str, sailor_enabled: bool) -> list[dict[str, Any]]:
    ...
    for index, workflow in enumerate(workflows, start=1):
        ...
        domain_tool_calls = [
            ...
            and call["tool_name"] not in {"error", "unknown_tool"}
        ]
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Generate complex phylogenetic experiment metrics from SQLite.")
